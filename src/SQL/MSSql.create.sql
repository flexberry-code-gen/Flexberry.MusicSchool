...
CREATE TABLE [PupilInGroup] (
	 ...
	 [Pupil_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Lesson] (
	 ...
	 [Teacher_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [PupilInGroup] ADD CONSTRAINT [PupilInGroup_FPupil_0] FOREIGN KEY ([Pupil_m0]) REFERENCES [Pupil]
CREATE INDEX PupilInGroup_IPupil_m0 on [PupilInGroup] ([Pupil_m0])

 ALTER TABLE [PupilInGroup] ADD CONSTRAINT [PupilInGroup_FGroup_0] FOREIGN KEY ([Group_m0]) REFERENCES [Group]
CREATE INDEX PupilInGroup_IGroup_m0 on [PupilInGroup] ([Group_m0])

 ALTER TABLE [Lesson] ADD CONSTRAINT [Lesson_FTeacher_0] FOREIGN KEY ([Teacher_m0]) REFERENCES [Teacher]
CREATE INDEX Lesson_ITeacher_m0 on [Lesson] ([Teacher_m0])

 ALTER TABLE [Lesson] ADD CONSTRAINT [Lesson_FPupil_0] FOREIGN KEY ([Pupil_m0]) REFERENCES [Pupil]
